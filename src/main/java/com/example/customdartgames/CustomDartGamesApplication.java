	...
	CommandLineRunner seedPlater(UserRepository userRepository, GameRepository gameRepository,
		...
		return args -> {
			if (userRepository.count() == 0) {
				...
				userGameStats.setId(new UserGameStatsId(null, null));
				...
				userGameStats2.setId(new UserGameStatsId(null, null));
				userGameStats2.setUser(user);
				userGameStats2.setGame(ballBase);
				userGameStats2.setWorstScore(1);
				userGameStatsRepository.save(userGameStats2);
